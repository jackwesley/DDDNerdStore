...
namespace NerdStore.WebApp.MVC.Controllers
{
    public class CarrinhoController : ControllerBase
    {
        ...
        {
            return View(await _pedidoQueries.ObterCarrinhoClienteAsync(ClienteId));
        }
        ...
        public async Task<IActionResult> AdicionarItem(Guid id, int quantidade)
        {
            ...
            var command = new AdicionarItemPedidoCommand(ClienteId, produto.Id,
                produto.Nome, quantidade, produto.Valor);
        ...
        //    return View("Index", await _pedidoQueries.ObterCarrinhoClienteAsync(ClienteId));
        //}
        ...
        //{
        //    var carrinho = await _pedidoQueries.ObterCarrinhoClienteAsync(ClienteId);
        ...
        //    return View("ResumoDaCompra", await _pedidoQueries.ObterCarrinhoClienteAsync(ClienteId));
        //}
    }
}
